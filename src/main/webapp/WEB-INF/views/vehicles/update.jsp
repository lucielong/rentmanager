      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /vehicles/create -->
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/vehicles/update?id=${vehicle.id}">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="seats" name="seats" value="${vehicle.nb_places}" required>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
